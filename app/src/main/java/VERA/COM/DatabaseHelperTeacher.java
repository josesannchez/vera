...
public class DatabaseHelperTeacher extends SQLiteOpenHelper {
    ...
    private static final String KEY_COURSE = "apellido";
    ...
    public long addTeachersDetail(String nombre, String apellido, String correo,String celular) {
        SQLiteDatabase db = this.getWritableDatabase();
        // Creating content values
        ContentValues values = new ContentValues();
        values.put(KEY_FIRSTNAME, nombre);
        values.put(KEY_COURSE, apellido);
        values.put(KEY_EMAIL, correo);
        values.put(KEY_PHONE, celular);
        //insert row in table
    ...
    public int updateTeachers(int id, String nombre, String apellido, String correo,String telefono) {
        SQLiteDatabase db = this.getWritableDatabase();
