...
public class CustomMod extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvname.setText("RUTA: "+teachersModelArrayList.get(position).getName());
        holder.tvcourse.setText("ORIGEN: "+teachersModelArrayList.get(position).getCourse());
        holder.tvemail.setText("DESTINO: "+teachersModelArrayList.get(position).getEmail());
        holder.tvphone.setText("TIEMPO "+teachersModelArrayList.get(position).getPhone());
