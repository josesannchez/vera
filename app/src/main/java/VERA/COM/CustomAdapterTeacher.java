...
public class CustomAdapterTeacher extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvname.setText("nombre: "+teachersModelArrayList.get(position).getName());
        holder.tvcourse.setText("apellido: "+teachersModelArrayList.get(position).getCourse());
        holder.tvemail.setText("correo: "+teachersModelArrayList.get(position).getEmail());
        holder.tvphone.setText("celular"+teachersModelArrayList.get(position).getPhone());
    ...
    private class ViewHolder {
        ...
        protected TextView tvname, tvcourse, tvemail, tvphone,tvcompañia;
    }
